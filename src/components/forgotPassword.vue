<template>
	<div class="forgotPassword">
		...
		<ul class="middle">
			<li>
				<input type="number" name="mobile" placeholder="请输入手机号" v-model="items.value1" ref="type1">
			</li>
			<li>
...
<style type="text/css" scoped="">
	.forgotPassword{ font-size: 0.32rem; height: 13.34rem; background: #fff; }
	...
	export default{
		...
		methods: {
			getVerificationCode: function(){
				var data = {
                    phone: '15201296417', //   string  是   手机号
